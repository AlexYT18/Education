...
//Либо цифра лиюо минус
//Дальше само числа по сивольно заполняю ll
//Если нашли не нулевой сиволь, не ulUL, то скип до пробела или конца строки 
//Если двойная ковыска, то скип до двойной ковычки, аналогично с одинарными
//После всего, обнуляем itog и следим, чтоб он не вклыдвался в дерево
//Если ulUL аналоги один раз появляются 
//Если ненулевой и не циферный, то скипает до конца строки или точки
//Написать функцию заново, основываясь на всем вышеперечисленном.
//1 (66) [67 - COUNT(-1)]
//0 (112) [92 - COUNT('0')]
//На самом деле все работает, просто, у нас в вс не считает их количесвто, а считает количсетво строк 